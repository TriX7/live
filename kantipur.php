  ...
  <body>
    ...
    <section class="content-background live-station">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <img src="img/kantipur.png" ><br>
            <audio width="500" height="60" controls="controls"><source src="https://radio-broadcast.ekantipur.com/stream" type="audio/mpeg"/></audio>
          </div>
          <div class="col-md-8 live-text">
            <h1>Radio Kantipur</h1>
            <p>
